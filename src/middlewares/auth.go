...
func IsAuthenticated(c *fiber.Ctx) error {
	...
	token, err := jwt.ParseWithClaims(cookie, &ClaimsWithScopes{}, func(token *jwt.Token) (interface{}, error) {
	...
	payload := token.Claims.(*ClaimsWithScopes)
